...
{
    /// <summary>
    /// Unpins a pinned item in clipboard history.
    /// </summary>
    public class UnpinCommand : Command
    {
        /// <summary>
        /// Creates a new <see cref="UnpinCommand"/> with the given argument, option, and handler.
        /// </summary>
        /// <remarks>
        ...
        public UnpinCommand(
            ...
            : base("unpin", "[Experimental] Unpins the specified pinned item from clipboard history")
        {
